<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="backup_store_location" name="backup_store_location" value="{$form_data['backup_store_location']}" class="" required="required" /></div>
