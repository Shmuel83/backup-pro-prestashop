<div class="form-wrapper">
	<div class="form-group {if $form_errors['dropbox_access_token']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['dropbox_app_secret']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['dropbox_prefix']|m62FormErrors}has-error{/if}">
		<label class="control-label col-lg-3" for="dropbox_prefix">{'dropbox_prefix'|m62Lang}</label>
		<div class="col-lg-6"><input type="text" id="dropbox_prefix" name="dropbox_prefix" value="{$form_data['dropbox_prefix']|escape:'htmlall':'UTF-8'}" class=""  /></div>
