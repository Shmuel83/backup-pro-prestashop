<div class="form-wrapper">
	<div class="form-group {if $form_errors['sftp_host']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['sftp_username']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['sftp_password']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['sftp_private_key']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['sftp_port']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['sftp_root']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['sftp_timeout']|m62FormErrors}has-error{/if}">
