<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="sftp_host" name="sftp_host" value="{$form_data['sftp_host']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="sftp_username" name="sftp_username" value="{$form_data['sftp_username']}" class="" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="password" id="sftp_password" name="sftp_password" value="{$form_data['sftp_password']}" class="" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="sftp_private_key" name="sftp_private_key" value="{$form_data['sftp_private_key']}" class="" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="sftp_port" name="sftp_port" value="{$form_data['sftp_port']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="sftp_root" name="sftp_root" value="{$form_data['sftp_root']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="sftp_timeout" name="sftp_timeout" value="{$form_data['sftp_timeout']}" class="" required="required" /></div>
