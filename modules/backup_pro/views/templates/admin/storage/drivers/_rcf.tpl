<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="rcf_username" name="rcf_username" value="{$form_data['rcf_username']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="password" id="rcf_api" name="rcf_api" value="{$form_data['rcf_api']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="rcf_container" name="rcf_container" value="{$form_data['rcf_container']}" class="" required="required" /></div>
