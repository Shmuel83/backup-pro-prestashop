<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="gcs_access_key" name="gcs_access_key" value="{$form_data['gcs_access_key']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="password" id="gcs_secret_key" name="gcs_secret_key" value="{$form_data['gcs_secret_key']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="gcs_bucket" name="gcs_bucket" value="{$form_data['gcs_bucket']}" class="" required="required" /></div>
