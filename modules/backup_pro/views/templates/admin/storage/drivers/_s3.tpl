<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="s3_access_key" name="s3_access_key" value="{$form_data['s3_access_key']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="password" id="s3_secret_key" name="s3_secret_key" value="{$form_data['s3_secret_key']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="s3_bucket" name="s3_bucket" value="{$form_data['s3_bucket']}" class="" required="required" /></div>
...
<div class="form-wrapper">
	<div class="form-group">
		<label class="control-label col-lg-3 required" for="rcf_container">{'s3_optional_prefix'|m62Lang}</label>
		<div class="col-lg-6"><input type="text" id="s3_optional_prefix" name="s3_optional_prefix" value="{$form_data['s3_optional_prefix']}" class="" required="required" /></div>
