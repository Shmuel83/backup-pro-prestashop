...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="s3_optional_prefix" name="s3_optional_prefix" value="{$form_data['s3_optional_prefix']|escape:'htmlall':'UTF-8'}" class="" required="required" /></div>
