<div class="form-wrapper">
	<div class="form-group {if $form_errors['email_storage_emails']|m62FormErrors}has-error{/if}">
...
<div class="form-wrapper">
	<div class="form-group {if $form_errors['email_storage_attach_threshold']|m62FormErrors}has-error{/if}">
