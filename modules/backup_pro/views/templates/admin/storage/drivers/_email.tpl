<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><textarea id="email_storage_emails" name="email_storage_emails" style="height:150px;" required="required">{$form_data['email_storage_emails']}</textarea></div>
...
<div class="form-wrapper">
	<div class="form-group">
		...
		<div class="col-lg-6"><input type="text" id="email_storage_attach_threshold" name="email_storage_attach_threshold" value="{$form_data['email_storage_attach_threshold']}" class="" required="required" /></div>
