...
<div class="panel">
	...
	<div class="form-wrapper">
		<div class="form-group {if $form_errors['db_verification_db_name']|m62FormErrors}has-error{/if}">
	...
	<div class="form-wrapper">
		<div class="form-group {if $form_errors['total_verifications_per_execution']|m62FormErrors}has-error{/if}">
...
<div class="panel">
	...
	<div class="form-wrapper">
		<div class="form-group {if $form_errors['backup_missed_schedule_notify_email_interval']|m62FormErrors}has-error{/if}">
	...
	<div class="form-wrapper">
		<div class="form-group {if $form_errors['backup_missed_schedule_notify_emails']|m62FormErrors}has-error{/if}">
	...
	<div class="form-wrapper">
		<div class="form-group {if $form_errors['backup_missed_schedule_notify_email_subject']|m62FormErrors}has-error{/if}">
	...
	<div class="form-wrapper">
		<div class="form-group {if $form_errors['backup_missed_schedule_notify_email_message']|m62FormErrors}has-error{/if}">
